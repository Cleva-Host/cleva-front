...
$canonical = 'whois.php';
$ogTitle = 'Whois Lookup - Cleva';
$ogDescription = 'Your Ultimate Solution for Web Hosting, Domains, and Reseller Services';
$ogUrl = 'https://clevahost.com/whois.php';
$twitterTitle = 'Whois Lookup - Cleva';
                ...
                <div class="col-lg-12">
                    <div class="rts-hero__content domain">
                        ...
                        <form id="whois-lookup-form" action="whois-result.php" method="get" class="domain-form d-flex gap-2">
                            <input type="text" id="whois-domain-input" placeholder="Enter a domain name, e.g. example.com" name="domain" required>
                            <button class="submit-btn" type="submit"><span class="btn-text">Lookup</span></button>
                        </form>
                        <div id="whois-lookup-message" class="whois-lookup-message" hidden></div>
                ...
                <div class="col-lg-4 col-md-6 col-sm-10">
                    <div class="feature__card">
                        <div class="feature__card--content">
                            ...
                            <p class="description">
                                Cleva WHOIS search tool helps you check
                ...
                <div class="result-content">
                    <div class="result-content__left">
                        <h2 class="result-title fw-bold">What Is the WHOIS
                            Lookup Tool?</h2>
                        <p>Cleva WHOIS lookup tool shows the latest data registered
