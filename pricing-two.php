<?php
$pageTitle = 'Pricing Packages - Cleva';
...
$canonical = 'pricing-two.php';
$ogTitle = 'Pricing Packages - Cleva';
$ogDescription = 'Your Ultimate Solution for Web Hosting, Domains, and Reseller Services';
$ogUrl = 'https://clevahost.com/pricing-two.php';
$twitterTitle = 'Pricing Packages - Cleva';
                        ...
                        <div class="single-plan has-box-shadow">
                            <div class="single-plan__content">
                                ...
                                <button class="buy__plan btn__two">
                                    Price: <span rt-currency-symbol>$</span><span rt-price>7.99</span></span>
                                </button>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="single-plan has-box-shadow active">
                            <div class="single-plan__content">
                                ...
                                <button class="buy__plan btn__two">
                                    Price: <span rt-currency-symbol>$</span><span rt-price>19.99</span></span>
                                </button>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="single-plan has-box-shadow">
                            <div class="single-plan__content">
                                ...
                                <button class="buy__plan btn__two">
                                    Price: <span rt-currency-symbol>$</span><span rt-price>99.99</span>
                                </button>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="single-plan has-box-shadow">
                            <div class="single-plan__content">
                                ...
                                <button class="buy__plan btn__two">
                                    Price: <span rt-currency-symbol>$</span><span rt-price>399.99</span></span>
                                </button>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="single-plan has-box-shadow active">
                            <div class="single-plan__content">
                                ...
                                <button class="buy__plan btn__two">
                                    Price: <span rt-currency-symbol>$</span><span rt-price>199.99</span></span>
                                </button>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="single-plan has-box-shadow">
                            <div class="single-plan__content">
                                ...
                                <button class="buy__plan btn__two">
                                    Price: <span rt-currency-symbol>$</span><span rt-price>499.99</span>
                                </button>
                            </div>
                        </div>
                    </div>
