<?php
$pageTitle = 'Black Friday Deals - Cleva';
...
$canonical = 'black-friday.php';
$ogTitle = 'Black Friday Deals - Cleva';
$ogDescription = 'Your Ultimate Solution for Web Hosting, Domains, and Reseller Services';
$ogUrl = 'https://clevahost.com/black-friday.php';
$twitterTitle = 'Black Friday Deals - Cleva';
...
<?php include 'components/header.php'; ?>
    ...
    <!-- CLEVA SECURITY ANNOUNCEMENT SECTION -->
    ...
    <!-- CLEVA SECURITY ANNOUNCEMENT SECTION END -->
                            ...
                            <div class="accordion-item active">
                                ...
                                <div id="item__one" class="accordion-collapse collapse collapse show" aria-labelledby="first" data-bs-parent="#rts-accordion">
                                    <div class="accordion-body">
                                        Above all else, we strive to deliver outstanding customer experiences. When you buy a domain name from cleva, we guarantee it will be handed over.
                                    </div>
                                </div>
                            </div>
