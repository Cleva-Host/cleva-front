<?php
$pageTitle = 'Domain Registration - Cleva';
...
$canonical = 'domain-registration.php';
$ogTitle = 'Domain Registration - Cleva';
$ogDescription = 'Your Ultimate Solution for Web Hosting, Domains, and Reseller Services';
$ogUrl = 'https://clevahost.com/domain-registration.php';
$twitterTitle = 'Domain Registration - Cleva';
            ...
            <div class="row align-items-center">
                <div class="col-lg-12">
                    <div class="rts-hero__content domain">
                        ...
                        <p class="description" data-sal="slide-down" data-sal-delay="200" data-sal-duration="800">Enter the domain that you would like to transfer to Cleva</p>

                        <form id="domain-availability-form" action="domain-availability.php" method="get">
                            <div class="rts-hero__form-area">
                                <input type="text" id="domain-availability-input" placeholder="find your domain name" name="domain" required>
                        ...
                        <div id="domain-availability-message" class="whois-lookup-message" hidden></div>
