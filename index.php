<?php
$pageTitle = 'Cleva - Premium Web Hosting & Domain Services';
$metaDescription = 'Cleva - Your Ultimate Solution for Web Hosting, Domains, and Reseller Services';
$metaKeywords = 'Web Hosting, Domain Registration, Reseller Hosting, Cloud Hosting, VPS';
$canonical = 'index.php';
$ogTitle = 'Cleva - Premium Web Hosting & Domain Services';
$ogDescription = 'Your Ultimate Solution for Web Hosting, Domains, and Reseller Services';
$ogUrl = 'https://clevahost.com/';
$twitterTitle = 'Cleva - Premium Web Hosting & Domain Services';
                ...
                <div class="col-xl-6 col-lg-7 col-md-9 order-md-2 order-lg-0">
                    <div class="rts-hero-two__content">
                        ...
                        <div class="rts-hero-two__content--btn" data-sal="slide-down" data-sal-delay="500" data-sal-duration="800">
                            ...
                            <a href="contact.php" class="rts-btn btn__long border__white white__color">contact us
                                <i class="fa-regular fa-arrow-right"></i></a>
                        </div>
                        <div class="terms" data-aos="fade-down" data-sal="slide-down" data-sal-delay="600" data-sal-duration="800">
                            ...
                            <span>*Secure your domain and hosting today</span>
                        </div>
                    </div>
                </div>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="rts-ds-two__wrapper">
                        <form action="#" class="domain-search">
                ...
                <div class="col-lg-12">
                    <div class="rts-section section-style-two">
                        <div class="rts-section__two">
                            <h6 class="sub__title">Our Services</h6>
                            <h2 class="title" data-sal="slide-down" data-sal-delay="400" data-sal-duration="700">Premium
                                Hosting Solutions</h2>
                            <p class="description mb-0" data-sal="slide-down" data-sal-delay="500" data-sal-duration="800">Choose from our comprehensive range of hosting services designed
                                to meet your business needs with exceptional performance and reliability.</p>
                        </div>
                ...
                <div class="col-lg-8 col-xl-6 col-md-8">
                    <div class="service-two">
                        <div class="service-two__content">
                            ...
                            <h4 class="title">Professional web hosting solutions
                                with exceptional uptime and support.
                            </h4>
                            <a href="shared-hosting.php" class="primary__btn btn__two">Learn More</a>
                        </div>
                ...
                <div class="col-lg-4 col-xl-3 col-md-4 col-sm-6">
                    <div class="service-two-small">
                        <div class="service-two-small__content">
                            ...
                            <p class="description">VPS Hosting provides dedicated resources and scalability for growing businesses.
                            </p>
                ...
                <div class="col-lg-4 col-xl-3 col-md-4 col-sm-6">
                    <div class="service-two-small">
                        <div class="service-two-small__content">
                            ...
                            <p class="description">Powerful dedicated servers for maximum performance and control.
                            </p>
                ...
                <div class="col-lg-4 col-xl-3 col-md-4 col-sm-6">
                    <div class="service-two-small">
                        <div class="service-two-small__content">
                            ...
                            <p class="description">Professional business email solutions with security and reliability.
                            </p>
                ...
                <div class="col-lg-4 col-xl-3 col-md-4 col-sm-6">
                    <div class="service-two-small">
                        <div class="service-two-small__content">
                            ...
                            <a href="#" class="service-title">Ecommerce Hosting</a>
                            <p class="description">Optimized hosting for online stores with secure payment processing.
                            </p>
                ...
                <div class="col-lg-4 col-xl-3 col-md-4 col-sm-6">
                    <div class="service-two-small">
                        <div class="service-two-small__content">
                            ...
                            <p class="description">Scalable cloud infrastructure with high availability and uptime.
                            </p>
                ...
                <div class="col-lg-4 col-xl-3 col-md-4 col-sm-6">
                    <div class="service-two-small">
                        <div class="service-two-small__content">
                            ...
                            <p class="description">Start your hosting business with our reseller programs and support.
                            </p>
            ...
            <div class="row justify-content-center">
                <div class="col-xl-6">
                    <div class="rts-section text-center">
                        <h2 class="rts-section__title" data-sal="slide-down" data-sal-delay="100" data-sal-duration="800">Affordable Hosting Plans <br>
                            For Everyone</h2>
                        <p class="rts-section__description" data-sal="slide-down" data-sal-delay="200" data-sal-duration="800">Quality hosting at competitive prices with 24/7 support</p>
                    </div>
                </div>
            </div>
            <div class="row justify-content-center">
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="single-plan has-box-shadow">
                            <div class="single-plan__content">
                                ...
                                <h4 class="plan-title">Supreme Plan</h4>
                                <p class="description">Added privacy and security features</p>
                                <div class="border-separator"></div>
                                <div class="plan-feature">
                                    <ul class="plan-feature__list">
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="single-plan has-box-shadow active">
                            <div class="single-plan__content">
                                ...
                                <h5 class="plan-title">Pro Plan</h5>
                                <p class="description">Added privacy and security features</p>
                                <div class="border-separator"></div>
                                <div class="plan-feature">
                                    <ul class="plan-feature__list">
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="single-plan has-box-shadow">
                            <div class="single-plan__content">
                                ...
                                <h5 class="plan-title">Supreme Plan</h5>
                                <p class="description">Added privacy and security features</p>
                                <div class="border-separator"></div>
                                <div class="plan-feature">
                                    <ul class="plan-feature__list">
                                ...
                                <button class="buy__plan btn__two">
                                    Price: <span rt-currency-symbol>$</span><span rt-price>445.36</span>
                                </button>
                            </div>
                        </div>
                    </div>
            ...
            <div class="row">
                <div class="rts-cta-two__wrapper">
                    ...
                    <div class="cta-content" data-sal="slide-down" data-sal-delay="100" data-sal-duration="800">
                        <span>Need assistance with your choice?</span>
                        <h4>Get Expert Help
                            With Cleva Today</h4>
                    </div>
                    <div class="cta-btn">
                        ...
                        <div class="swiper-wrapper">
                                ...
                                <div class="rts-testimonial-two__single">
                                    ...
                                    <div class="testimonial-text">
                                        <h5>We are grateful to have found an ideal managed
                                            ...
                                            to grow our hosting business with Cleva.
                                        </h5>
                                    </div>
                                    <div class="rating">
                            ...
                            <div class="swiper-slide">
                                <div class="rts-testimonial-two__single">
                                    <div class="quote"><img src="assets/images/icon/quote__white.svg" alt=""></div>
                                    <div class="testimonial-text">
                                        <h5>Cleva made switching our entire hosting
                                            infrastructure painless. Their migration team
                                            handled everything, and we didn't lose a minute of uptime.
                                        </h5>
                                    </div>
                                    <div class="rating">
                                        <i class="fa-solid fa-star"></i>
                            ...
                            <div class="swiper-slide">
                                <div class="rts-testimonial-two__single">
                                    <div class="quote"><img src="assets/images/icon/quote__white.svg" alt=""></div>
                                    <div class="testimonial-text">
                                        <h5>Domain registration and SSL setup used to take
                                            our team a full day. With Cleva, it's done
                            ...
                            <div class="swiper-slide">
                                <div class="rts-testimonial-two__single">
                                    <div class="quote"><img src="assets/images/icon/quote__white.svg" alt=""></div>
                                    <div class="testimonial-text">
                                        <h5>The reseller program gave us a real revenue
                                            stream. Cleva's support and pricing structure
                                            make it easy to build a hosting business on top of theirs.
                                        </h5>
                                    </div>
                                    <div class="rating">
                                        <i class="fa-solid fa-star"></i>
            ...
            <div class="row">
                <div class="col-12">
                    <div class="cta__button">
                        <p>Looking for the perfect hosting solution?</p><a href="contact.php" class="light__cta">Contact Us</a>
                    </div>
                </div>
            </div>
                ...
                <div class="col-lg-12">
                    <div class="rts-brand__wrapper">
                        <div class="rts-brand__wrapper--text">
                            <h3 class="animated fadeIn">Premium hosting trusted by
                                <span>5,000+</span> satisfied customers worldwide.
                            </h3>
                            <div class="rts-brand__wrapper--text-review">
                                ...
                                <div class="review__company">
                                    Trusted & Reliable Hosting Provider
                                </div>
                            </div>
                        </div>
