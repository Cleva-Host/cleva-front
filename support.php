...
$canonical = 'support.php';
$ogTitle = 'Support - Cleva';
$ogDescription = 'Your Ultimate Solution for Web Hosting, Domains, and Reseller Services';
$ogUrl = 'https://clevahost.com/support.php';
$twitterTitle = 'Support - Cleva';
...
<?php include 'components/header.php'; ?>
    ...
    <!-- PROMOTE CLEVA -->
    <div class="rts-promote-cleva alice__blue section__padding">
        <div class="container">
                    ...
                    <div class="form">
                        ...
                        <form class="form__content" method="post" action="#">
                            ...
                            <label for="checkbox">
                                ...
                                to cleva and its family of brands contacting you.
                            </label>
                        ...
                        <div class="swiper-slide">
                            <div class="feedback-card">
                                ...
                                <div class="feedback-card__single">
                                    ...
                                    <p class="feedback-card__single--text">Every time we've opened a ticket, a real person responded within minutes — not a bot, not a queue.</p>
                        ...
                        <div class="swiper-slide">
                            <div class="feedback-card">
                                ...
                                <div class="feedback-card__single">
                                    ...
                                    <p class="feedback-card__single--text">Cleva's support team once stayed on a call with me past midnight to fix a broken migration. That's rare.</p>
                                    <div class="feedback-card__single--author">
                                        <div class="author">
                        ...
                        <div class="swiper-slide">
                            <div class="feedback-card">
                                ...
                                <div class="feedback-card__single">
                                    ...
                                    <p class="feedback-card__single--text">Their knowledge base answers most of my questions, but when it doesn't, live chat actually helps.</p>
                                    <div class="feedback-card__single--author">
                                        <div class="author">
                                            <img src="assets/images/author/author__one.png" height="50" width="50" alt="">
                                        </div>
                        ...
                        <div class="swiper-slide">
                            <div class="feedback-card">
                                ...
                                <div class="feedback-card__single">
                                    ...
                                    <p class="feedback-card__single--text">Support walked me through a DNS issue step by step instead of just sending a help article link.</p>
                                    <div class="feedback-card__single--author">
                                        <div class="author">
