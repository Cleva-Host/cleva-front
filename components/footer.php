            ...
            <div class="row">
                ...
                <div class="col-lg-3 col-md-6 col-sm-6 rts-footer__widget--column">
                    <div class="rts-footer__widget footer__widget w-230">
                        ...
                        <p class="brand-desc address">Cleva Hosting Services <br> Your City, Your Country</p>
        ...
        <div class="container">
            <div class="row">
                <div class="rts-footer__copyright-two__wrapper">
                    <p class="copyright">&copy; Copyright 2026 Cleva. All Rights Reserved.</p>
            ...
            <nav class="nav-main mainmenu-nav mt--30">
                <ul class="mainmenu metismenu" id="mobile-menu-active">
                    <li class="has-droupdown">
                        <a href="#" class="main">Domains</a>
                        <ul class="submenu mm-collapse">
                            <li><a class="mobile-menu-link" href="domain-registration.php">Domain Registration</a></li>
                            ...
                            <li><a class="mobile-menu-link" href="whois.php">Whois Lookup</a></li>
                        </ul>
                    </li>
                    <li><a class="mobile-menu-link main" href="business-mail.php">Email</a></li>
                    <li class="has-droupdown">
                    ...
                    <li><a class="mobile-menu-link main" href="ssl-certificate.php">Security</a></li>
                    <li class="has-droupdown">
                        ...
                        <ul class="submenu mm-collapse">
                            ...
                            <li><a class="mobile-menu-link" href="faq.php">FAQ</a></li>
    ...
    <!-- currency js -->
    <script defer src="assets/js/currency/app.js?v=<?php echo filemtime(__DIR__ . '/../assets/js/currency/app.js'); ?>"></script>
    <!-- main js -->
