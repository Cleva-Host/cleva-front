            ...
            <div class="row justify-content-sm-center">
                <div class="banner-area">
                    <div class="rts-hosting-banner rts-hosting-banner__content cloud__banner">
                        ...
                        <p class="slogan" data-sal="slide-down" data-sal-delay="300" data-sal-duration="800">Spin up cloud servers in seconds and scale resources on demand.</p>
                        <div class="hosting-action">
                            <a href="pricing.php" class="btn__two secondary__bg secondary__color">View Plans <i class="fa-regular fa-arrow-right"></i></a>
                            <a href="pricing-two.php" class="btn__white">Starting @ $12.99/mo</a>
                        </div>
                    </div>
        ...
        <div class="container">
            <div class="row justify-content-center">
                <div class="rts-section  text-center">
                    <h2 class="rts-section__title" data-sal="slide-down" data-sal-delay="100" data-sal-duration="800">Choose Your Cloud Plan</h2>
                    <p class="rts-section__description w-450" data-sal="slide-down" data-sal-delay="300" data-sal-duration="800">Pay only for what you use, with resources you can scale up in seconds.
                    </p>
                </div>
            </div>
            <div class="row">
                        ...
                        <div class="col-lg-3 col-md-6 col-sm-6">
                            <div class="card-plan">
                                <div class="card-plan__package">
                                    ...
                                    <h4 class="package__name">Cloud Starter</h4>
                                </div>
                                <p class="card-plan__desc">2 vCPU, 2GB RAM, 40GB SSD</p>
                                <div class="card-plan__offer">
                                    <span class="past-price"><span rt-currency-symbol>$</span><span rt-price>21.99</span></span></span>
                                    <span class="offer-given">Save 60%</span>
                                </div>
                                <h5 class="card-plan__price">
                                    <sup rt-currency-symbol>$</sup> <span rt-price>12.99</span></span><sub>/ month</sub>
                                </h5>
                                <div class="card-plan__cartbtn">
                                    <a href="#">add to cart</a>
                                </div>
                                <p class="card-plan__renew-price">
                                    <span rt-currency-symbol>$</span> <span rt-price>12.99</span> /mo when you renew
                                </p>
                        ...
                        <div class="col-lg-3 col-md-6 col-sm-6">
                            <div class="card-plan">
                                <div class="card-plan__package">
                                    ...
                                    <h4 class="package__name">Cloud Growth</h4>
                                </div>
                                <p class="card-plan__desc">4 vCPU, 4GB RAM, 80GB SSD</p>
                                <div class="card-plan__offer">
                                    <span class="past-price"><span rt-currency-symbol>$</span><span rt-price>37.99</span></span>
                                    <span class="offer-given">Save 60%</span>
                                </div>
                                <h5 class="card-plan__price">
                                    <sup rt-currency-symbol>$</sup> <span rt-price>22.99</span></span> <sub>/ month</sub>
                                </h5>
                                <div class="card-plan__cartbtn">
                                    <a href="#">add to cart</a>
                                </div>
                                <p class="card-plan__renew-price">
                                    <span rt-currency-symbol>$</span> <span rt-price>22.99</span> /mo when you renew
                                </p>
                                <div class="card-plan__feature">
                                    <ul class="card-plan__feature--list">
                                        <li class="card-plan__feature--list-item">
                        ...
                        <div class="col-lg-3 col-md-6 col-sm-6">
                            <div class="card-plan active">
                                ...
                                <div class="card-plan__package">
                                    ...
                                    <h4 class="package__name">Cloud Business</h4>
                                </div>
                                <p class="card-plan__desc">6 vCPU, 8GB RAM, 160GB SSD</p>
                                <div class="card-plan__offer">
                                    <span class="past-price"><span rt-currency-symbol>$</span><span rt-price>64.99</span></span>
                                    <span class="offer-given">Save 60%</span>
                                </div>
                                <h5 class="card-plan__price">
                                    <sup rt-currency-symbol>$</sup> <span rt-price>39.99</span></span> <sub>/ month</sub>
                                </h5>
                                <div class="card-plan__cartbtn">
                                    <a href="#">add to cart</a>
                                </div>
                                <p class="card-plan__renew-price">
                                    <span rt-currency-symbol>$</span> <span rt-price>39.99</span> /mo when you renew
                                </p>
                                <div class="card-plan__feature">
                                    <ul class="card-plan__feature--list">
                                        <li class="card-plan__feature--list-item">
                        ...
                        <div class="col-lg-3 col-md-6 col-sm-6">
                            <div class="card-plan ">
                                ...
                                <div class="card-plan__package">
                                    ...
                                    <h4 class="package__name">Cloud Enterprise</h4>
                                </div>
                                <p class="card-plan__desc">8 vCPU, 16GB RAM, 320GB SSD</p>
                                <div class="card-plan__offer">
                                    <span class="past-price"> <span rt-currency-symbol>$</span><span rt-price>114.99</span></span>
                                    <span class="offer-given">Save 60%</span>
                                </div>
                                <h5 class="card-plan__price">
                                    <sup rt-currency-symbol>$</sup> <span rt-price>69.99</span></span> <sub>/ month</sub>
                                </h5>
                                <div class="card-plan__cartbtn">
                                    <a href="#">add to cart</a>
                                </div>
                                <p class="card-plan__renew-price">
                                    <span rt-currency-symbol>$</span> <span rt-price>69.99</span> /mo when you renew
                                </p>
                                <div class="card-plan__feature">
                                    <ul class="card-plan__feature--list">
                                        <li class="card-plan__feature--list-item">
                        ...
                        <div class="swiper-slide">
                            <div class="feedback-card">
                                ...
                                <div class="feedback-card__single">
                                    ...
                                    <p class="feedback-card__single--text">Scaling up during traffic spikes used to mean downtime. On Cleva's cloud plan we just add resources and keep going.</p>
                        ...
                        <div class="swiper-slide">
                            <div class="feedback-card">
                                ...
                                <div class="feedback-card__single">
                                    ...
                                    <p class="feedback-card__single--text">Deploying to Cleva's cloud servers is the fastest setup I've had with any host — SSH access within minutes.</p>
                                    <div class="feedback-card__single--author">
                                        <div class="author">
                        ...
                        <div class="swiper-slide">
                            <div class="feedback-card">
                                ...
                                <div class="feedback-card__single">
                                    ...
                                    <p class="feedback-card__single--text">Auto-scaling actually works as advertised. We haven't touched a config file since we set it up.</p>
                                    <div class="feedback-card__single--author">
                                        <div class="author">
                        ...
                        <div class="swiper-slide">
                            <div class="feedback-card">
                                ...
                                <div class="feedback-card__single">
                                    ...
                                    <p class="feedback-card__single--text">Our store stayed up through Black Friday traffic for the first time ever after moving to Cleva's cloud hosting.</p>
                                    <div class="feedback-card__single--author">
                                        <div class="author">
                            ...
                            <div class="accordion-item active">
                                <div class="accordion-header" id="first">
                                    <h4 class="accordion-button collapse show" data-bs-toggle="collapse" data-bs-target="#item__one" aria-expanded="false" aria-controls="item__one">
                                        How is cloud hosting different from a regular VPS?
                                    </h4>
                                </div>
                                <div id="item__one" class="accordion-collapse collapse collapse show" aria-labelledby="first" data-bs-parent="#rts-accordion">
                                    <div class="accordion-body">
                                        Cloud hosting runs across a cluster of servers instead of one physical machine, so resources can scale up instantly and your site stays online even if a single server has an issue.
                                    </div>
                                </div>
                            </div>
                            <div class="accordion-item">
                                <div class="accordion-header" id="two">
                                    <h4 class="accordion-button collapsed" data-bs-toggle="collapse" data-bs-target="#item__two" aria-expanded="false" aria-controls="item__two">
                                        Can I scale resources up or down as traffic changes?
                                    </h4>
                                </div>
                                <div id="item__two" class="accordion-collapse collapse" aria-labelledby="two" data-bs-parent="#rts-accordion">
                                    <div class="accordion-body">
                                        Yes, you can resize your cloud server's CPU, RAM and storage from your dashboard in seconds, without rebuilding your server.
                                    </div>
                                </div>
                            </div>
                            <div class="accordion-item">
                                <div class="accordion-header" id="three">
                                    <h4 class="accordion-button collapsed" data-bs-toggle="collapse" data-bs-target="#item__three" aria-expanded="false" aria-controls="item__three">
                                        Is my data replicated for reliability?
                                    </h4>
                                </div>
                                <div id="item__three" class="accordion-collapse collapse" aria-labelledby="three" data-bs-parent="#rts-accordion">
                                    <div class="accordion-body">
                                        Yes, your storage is backed by redundant, replicated infrastructure so a single hardware failure won't take your site down.
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="accordion-item">
                                <div class="accordion-header" id="four">
                                    <h4 class="accordion-button collapsed" data-bs-toggle="collapse" data-bs-target="#item__four" aria-expanded="false" aria-controls="item__four">
                                        Can I run multiple applications on one cloud plan?
                                    </h4>
                                </div>
                                <div id="item__four" class="accordion-collapse collapse" aria-labelledby="four" data-bs-parent="#rts-accordion">
                                    <div class="accordion-body">
                                        Yes, each cloud plan gives you a full virtual server, so you can host multiple sites, apps or services side by side.
                                    </div>
                                </div>
                            </div>
                            <div class="accordion-item">
                                ...
                                <div id="item__five" class="accordion-collapse collapse" aria-labelledby="five" data-bs-parent="#rts-accordion">
                                    <div class="accordion-body">
                                        Our cloud infrastructure is backed by a 99.99% uptime guarantee, with automatic failover across the underlying server cluster.
                                    </div>
                                </div>
                            </div>
