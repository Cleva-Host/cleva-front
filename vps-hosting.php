...
$ogTitle = 'VPS Hosting - Cleva';
$ogDescription = 'Your Ultimate Solution for Web Hosting, Domains, and Reseller Services';
$ogUrl = 'https://clevahost.com/vps-hosting.php';
$twitterTitle = 'VPS Hosting - Cleva';
...
<?php include 'components/header.php'; ?>
            ...
            <div class="row justify-content-sm-center">
                <div class="banner-area">
                    <div class="rts-hosting-banner rts-hosting-banner__content">
                        <span class="starting__price" data-sal="slide-down" data-sal-delay="100" data-sal-duration="800">Customizable VPS Hosting</span>
                        <h1 class="banner-title" data-sal="slide-down" data-sal-delay="200" data-sal-duration="800">
                            Fast & Reliable
                            Virtual Private Servers
                        </h1>
                        <p class="slogan" data-sal="slide-down" data-sal-delay="300" data-sal-duration="800">NVMe SSD storage, full root access, and a 99.99% uptime guarantee.</p>
                        <div class="hosting-action">
                            ...
                            <a href="pricing-two.php" class="btn__white">Starting @ $9.99/mo</a>
                        </div>
                    </div>
                ...
                <div class="col-lg-6">
                    <div class="rts-feature-section">
                        ...
                        <p data-sal="slide-down" data-sal-delay="200" data-sal-duration="800">
                            Own your virtual presence with the power of Cleva
                    ...
                    <div class="card-feature">
                        <div class="card-feature__single">
                            ...
                            <p class="card-feature__single--description">
                                Automatic security patches keep
                                your server hardened around the clock.
                            </p>
                        </div>
                    </div>
                </div>
                <div class="col-lg-3 col-md-4 col-sm-6" data-sal="slide-down" data-sal-delay="400" data-sal-duration="800">
                    <div class="card-feature">
                        <div class="card-feature__single">
                            ...
                            <p class="card-feature__single--description">
                                Choose the vCPU, RAM and SSD
                                that fit your workload exactly.
                            </p>
                        </div>
                    </div>
                </div>
                <div class="col-lg-3 col-md-4 col-sm-6" data-sal="slide-down" data-sal-delay="500" data-sal-duration="800">
                    <div class="card-feature">
                        <div class="card-feature__single">
                            ...
                            <p class="card-feature__single--description">
                                Spin up a new server in under
                                60 seconds, no waiting around.
                            </p>
                        </div>
                    </div>
                </div>
                <div class="col-lg-3 col-md-4 col-sm-6" data-sal="slide-down" data-sal-delay="600" data-sal-duration="800">
                    <div class="card-feature">
                        <div class="card-feature__single">
                            ...
                            <p class="card-feature__single--description">
                                No caps, no overage fees —
                                traffic scales with your growth.
                            </p>
                        </div>
                    </div>
                </div>
                <div class="col-lg-3 col-md-4 col-sm-6" data-sal="slide-down" data-sal-delay="700" data-sal-duration="800">
                    <div class="card-feature">
                        <div class="card-feature__single">
                            ...
                            <p class="card-feature__single--description">
                                NVMe SSD storage, free SSL and
                                mailboxes on every plan.
                            </p>
                        </div>
                    </div>
                </div>
                <div class="col-lg-3 col-md-4 col-sm-6" data-sal="slide-down" data-sal-delay="800" data-sal-duration="800">
                    <div class="card-feature">
                        <div class="card-feature__single">
                            ...
                            <p class="card-feature__single--description">
                                Install any language runtime
                                or stack with full root access.
                            </p>
                        </div>
                    </div>
                </div>
    ...
    <!-- CLEVA QUICK FEATURE END -->
    <!-- PRICING PLAN START -->
    <div class="rts-pricing-plan section__padding">
        <div class="container">
            <div class="row justify-content-center">
                <div class="rts-section  text-center">
                    <h2 class="rts-section__title" data-sal="slide-down" data-sal-delay="100" data-sal-duration="800">Choose Your VPS Plan</h2>
                    <p class="rts-section__description w-450" data-sal="slide-down" data-sal-delay="300" data-sal-duration="800">Every server includes full root access, static IPv4, unlimited traffic and 99.99% uptime.
                    </p>
                </div>
            </div>
            <div class="row">
                        ...
                        <div class="col-lg-3 col-md-6 col-sm-6">
                            <div class="card-plan">
                                <div class="card-plan__package">
                                    ...
                                    <h4 class="package__name">C1 Server</h4>
                                </div>
                                <p class="card-plan__desc">1 vCore, 1GB RAM, 20GB NVMe SSD</p>
                                <div class="card-plan__offer">
                                    <span class="past-price"><span rt-currency-symbol>$</span><span rt-price>19.99</span></span></span>
                                    <span class="offer-given">Save 60%</span>
                                </div>
                                <h5 class="card-plan__price">
                                    <sup rt-currency-symbol>$</sup> <span rt-price>9.99</span></span><sub>/ month</sub>
                                </h5>
                                <div class="card-plan__cartbtn">
                                    <a href="#">add to cart</a>
                                </div>
                                <p class="card-plan__renew-price">
                                    <span rt-currency-symbol>$</span> <span rt-price>9.99</span> /mo when you renew
                                </p>
                                <div class="card-plan__feature">
                                    <ul class="card-plan__feature--list">
                                        ...
                                        <li class="card-plan__feature--list-item">
                                            ...
                                            <span class="tolltip" data-bs-toggle="tooltip" data-bs-placement="bottom" data-bs-original-title="Cleva provides reliable 24/7 support for your hosting needs, ensuring assistance whenever you require help."><i class="fa-light fa-circle-question"></i></span>
                                        </li>
                                        <li class="card-plan__feature--list-item">
                                            <span class="text"><i class="fa-regular fa-xmark"></i> Free Email</span>
                                            <span class="tolltip" data-bs-toggle="tooltip" data-bs-placement="bottom" data-bs-original-title="Cleva offers complimentary email services, empowering your online communication with reliable and secure free email solutions."><i class="fa-light fa-circle-question"></i></span>
                                        </li>
                                        <li class="card-plan__feature--list-item">
                                            <span class="text"><i class="fa-regular fa-xmark"></i> Unlimited Bandwidth</span>
                                            <span class="tolltip" data-bs-toggle="tooltip" data-bs-placement="bottom" data-bs-original-title="Cleva provides unlimited bandwidth, ensuring seamless data transfer for your website's optimal performance and user experience."><i class="fa-light fa-circle-question"></i></span>
                                        </li>
                                        <li class="card-plan__feature--list-item">
                                            <span class="text"><i class="fa-regular fa-xmark"></i> 100 GB SSD Storage</span>
                                            <span class="tolltip" data-bs-toggle="tooltip" data-bs-placement="bottom" data-bs-original-title="Elevate your online presence with Cleva, offering unlimited bandwidth for your domain, ensuring optimal performance and seamless data flow."><i class="fa-light fa-circle-question"></i></span>
                                        </li>


                                        <li class="card-plan__feature--list-item">
                                            <span class="text"><i class="fa-regular fa-check"></i> Unlimited Free SSL</span>
                                            <span class="tolltip" data-bs-toggle="tooltip" data-bs-placement="bottom" data-bs-original-title="Secure your website with Cleva's unlimited free SSL certificates, ensuring encrypted and safe online transactions for your users."><i class="fa-light fa-circle-question"></i></span>
                                        </li>
                                        <li class="card-plan__feature--list-item">
                                            <span class="text"><i class="fa-regular fa-check"></i> 99.9% Uptime Guarantee</span>
                                            <span class="tolltip" data-bs-toggle="tooltip" data-bs-placement="bottom" data-bs-original-title="Cleva guarantees 99% uptime, ensuring your website is consistently available and reliable for visitors around the clock."><i class="fa-light fa-circle-question"></i></span>
                                        </li>
                                        <li class="card-plan__feature--list-item">
                                            <span class="text"><i class="fa-regular fa-xmark"></i> Web Application Firewall</span>
                                            <span class="tolltip" data-bs-toggle="tooltip" data-bs-placement="bottom" data-bs-original-title="Enhance your website's security with Cleva's Web Application Firewall, protecting against online threats and ensuring a safe online environment."><i class="fa-light fa-circle-question"></i></span>
                                        </li>
                                    ...
                                    <ul class="card-plan__feature--list more__feature">
                                        <li class="card-plan__feature--list-item">
                                            ...
                                            <span class="tolltip" data-bs-toggle="tooltip" data-bs-placement="bottom" data-bs-original-title="Cleva offers generous hosting with 100GB SSD storage, providing ample space for your data and ensuring high-performance storage solutions."><i class="fa-light fa-circle-question"></i></span>
                                        </li>
                                        <li class="card-plan__feature--list-item">
                                            <span class="text"><i class="fa-regular fa-check"></i> Unlimited Free SSL</span>
                                            <span class="tolltip" data-bs-toggle="tooltip" data-bs-placement="bottom" data-bs-original-title="Secure your website with Cleva's unlimited free SSL certificates, ensuring encrypted and safe online transactions for your users."><i class="fa-light fa-circle-question"></i></span>
                        ...
                        <div class="col-lg-3 col-md-6 col-sm-6">
                            <div class="card-plan">
                                <div class="card-plan__package">
                                    ...
                                    <h4 class="package__name">C2 Server</h4>
                                </div>
                                <p class="card-plan__desc">2 vCores, 2GB RAM, 40GB NVMe SSD</p>
                                <div class="card-plan__offer">
                                    <span class="past-price"><span rt-currency-symbol>$</span><span rt-price>34.99</span></span>
                                    <span class="offer-given">Save 60%</span>
                                </div>
                                <h5 class="card-plan__price">
                                    <sup rt-currency-symbol>$</sup> <span rt-price>17.99</span></span> <sub>/ month</sub>
                                </h5>
                                <div class="card-plan__cartbtn">
                                    <a href="#">add to cart</a>
                                </div>
                                <p class="card-plan__renew-price">
                                    <span rt-currency-symbol>$</span> <span rt-price>17.99</span> /mo when you renew
                                </p>
                                <div class="card-plan__feature">
                                    <ul class="card-plan__feature--list">
                                        <li class="card-plan__feature--list-item">
                        ...
                        <div class="col-lg-3 col-md-6 col-sm-6">
                            <div class="card-plan active">
                                ...
                                <div class="card-plan__package">
                                    ...
                                    <h4 class="package__name">C3 Server</h4>
                                </div>
                                <p class="card-plan__desc">4 vCores, 4GB RAM, 80GB NVMe SSD</p>
                                <div class="card-plan__offer">
                                    <span class="past-price"><span rt-currency-symbol>$</span><span rt-price>59.99</span></span>
                                    <span class="offer-given">Save 60%</span>
                                </div>
                                <h5 class="card-plan__price">
                                    <sup rt-currency-symbol>$</sup> <span rt-price>32.99</span></span> <sub>/ month</sub>
                                </h5>
                                <div class="card-plan__cartbtn">
                                    <a href="#">add to cart</a>
                                </div>
                                <p class="card-plan__renew-price">
                                    <span rt-currency-symbol>$</span> <span rt-price>32.99</span> /mo when you renew
                                </p>
                                <div class="card-plan__feature">
                                    <ul class="card-plan__feature--list">
                                        <li class="card-plan__feature--list-item">
                        ...
                        <div class="col-lg-3 col-md-6 col-sm-6">
                            <div class="card-plan ">
                                ...
                                <div class="card-plan__package">
                                    ...
                                    <h4 class="package__name">C4 Server</h4>
                                </div>
                                <p class="card-plan__desc">8 vCores, 8GB RAM, 160GB NVMe SSD</p>
                                <div class="card-plan__offer">
                                    <span class="past-price"> <span rt-currency-symbol>$</span><span rt-price>109.99</span></span>
                                    <span class="offer-given">Save 60%</span>
                                </div>
                                <h5 class="card-plan__price">
                                    <sup rt-currency-symbol>$</sup> <span rt-price>59.99</span></span> <sub>/ month</sub>
                                </h5>
                                <div class="card-plan__cartbtn">
                                    <a href="#">add to cart</a>
                                </div>
                                <p class="card-plan__renew-price">
                                    <span rt-currency-symbol>$</span> <span rt-price>59.99</span> /mo when you renew
                                </p>
                                <div class="card-plan__feature">
                                    <ul class="card-plan__feature--list">
                                        <li class="card-plan__feature--list-item">
                    ...
                    <div class="row g-30 yearly">
                        ...
                        <div class="col-lg-3 col-md-6 col-sm-6">
                            <div class="card-plan active">
                                ...
                                <p class="card-plan__desc">Everything need to your website</p>
                                <div class="card-plan__offer">
                                    <span class="past-price"><span>$</span><span rt-price>233.63</span></span>
                                    <span class="offer-given">Save 60%</span>
                                </div>
                                <h5 class="card-plan__price">
                        ...
                        <div class="col-lg-3 col-md-6 col-sm-6">
                            <div class="card-plan ">
                                ...
                                <p class="card-plan__desc">Everything need to your website</p>
                                <div class="card-plan__offer">
                                    <span class="past-price"> <span>$</span><span>339.63</span></span>
                                    <span class="offer-given">Save 60%</span>
                                </div>
                                <h5 class="card-plan__price">
                                    <sup rt-currency-symbol>$</sup> <span>169.63</span></span> <sub>/ month</sub>
                                </h5>
                                <div class="card-plan__cartbtn">
                                    <a href="#">add to cart</a>
                                </div>
                        ...
                        <div class="swiper-slide">
                            <div class="feedback-card">
                                ...
                                <div class="feedback-card__single">
                                    ...
                                    <p class="feedback-card__single--text">Our VPS gives us the flexibility of a dedicated server at a fraction of the cost, with support that actually knows Linux.</p>
                        ...
                        <div class="swiper-slide">
                            <div class="feedback-card">
                                ...
                                <div class="feedback-card__single">
                                    ...
                                    <p class="feedback-card__single--text">Root access on the VPS lets me install exactly what my stack needs, no restrictions.</p>
                                    <div class="feedback-card__single--author">
                                        <div class="author">
                        ...
                        <div class="swiper-slide">
                            <div class="feedback-card">
                                ...
                                <div class="feedback-card__single">
                                    ...
                                    <p class="feedback-card__single--text">Resizing our VPS resources took two minutes and zero downtime when our app started growing.</p>
                                    <div class="feedback-card__single--author">
                                        <div class="author">
                        ...
                        <div class="swiper-slide">
                            <div class="feedback-card">
                                ...
                                <div class="feedback-card__single">
                                    ...
                                    <p class="feedback-card__single--text">We run every client's staging environment on one VPS now, and performance has never been an issue.</p>
                                    <div class="feedback-card__single--author">
                                        <div class="author">
    ...
    <!-- CLEVA CLIENT FEEDBACK AREA END -->
                            ...
                            <div class="accordion-item active">
                                ...
                                <div id="item__one" class="accordion-collapse collapse collapse show" aria-labelledby="first" data-bs-parent="#rts-accordion">
                                    <div class="accordion-body">
                                        Shared hosting puts many sites on one server sharing resources. VPS gives you dedicated vCPU, RAM and SSD storage on your own virtual server, with full root access to install anything you need.
                                    </div>
                                </div>
                            </div>
                            <div class="accordion-item">
                                <div class="accordion-header" id="two">
                                    <h4 class="accordion-button collapsed" data-bs-toggle="collapse" data-bs-target="#item__two" aria-expanded="false" aria-controls="item__two">
                                        Do I get root/SSH access to my VPS?
                                    </h4>
                                </div>
                                <div id="item__two" class="accordion-collapse collapse" aria-labelledby="two" data-bs-parent="#rts-accordion">
                                    <div class="accordion-body">
                                        Yes, every plan ships with full root access and SSH from the moment your server is provisioned, so you have complete control over the environment.
                                    </div>
                                </div>
                            </div>
                            <div class="accordion-item">
                                <div class="accordion-header" id="three">
                                    <h4 class="accordion-button collapsed" data-bs-toggle="collapse" data-bs-target="#item__three" aria-expanded="false" aria-controls="item__three">
                                        Can I upgrade to a bigger server later?
                                    </h4>
                                </div>
                                <div id="item__three" class="accordion-collapse collapse" aria-labelledby="three" data-bs-parent="#rts-accordion">
                                    <div class="accordion-body">
                                        Yes, you can scale up to a larger C-series plan at any time from your account panel as your traffic or workload grows.
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="accordion-item">
                                <div class="accordion-header" id="four">
                                    <h4 class="accordion-button collapsed" data-bs-toggle="collapse" data-bs-target="#item__four" aria-expanded="false" aria-controls="item__four">
                                        Is managed support available for VPS hosting?
                                    </h4>
                                </div>
                                <div id="item__four" class="accordion-collapse collapse" aria-labelledby="four" data-bs-parent="#rts-accordion">
                                    <div class="accordion-body">
                                        Our team is available 24/7 for server-level support, and managed setup/hardening is available as an add-on if you'd rather not manage it yourself.
                                    </div>
                                </div>
                            </div>
                            <div class="accordion-item">
                                <div class="accordion-header" id="five">
                                    <h4 class="accordion-button collapsed" data-bs-toggle="collapse" data-bs-target="#item__five" aria-expanded="false" aria-controls="item__four">
                                        Can I install my own software and custom stack?
                                    </h4>
                                </div>
                                <div id="item__five" class="accordion-collapse collapse" aria-labelledby="five" data-bs-parent="#rts-accordion">
                                    <div class="accordion-body">
                                        Yes. With full root access and your choice of Linux distribution, you can install any software, language runtime, or custom stack your project needs.
                                    </div>
                                </div>
                            </div>
