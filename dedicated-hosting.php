<?php
$pageTitle = 'Dedicated Hosting - Cleva';
...
$canonical = 'dedicated-hosting.php';
$ogTitle = 'Dedicated Hosting - Cleva';
$ogDescription = 'Your Ultimate Solution for Web Hosting, Domains, and Reseller Services';
$ogUrl = 'https://clevahost.com/dedicated-hosting.php';
$twitterTitle = 'Dedicated Hosting - Cleva';
$twitterDescription = 'Your Ultimate Solution for Web Hosting, Domains, and Reseller Services';
$bodyClass = 'page-template template-dedicated';
?>
            ...
            <div class="row justify-content-sm-center">
                <div class="banner-area">
                    <div class="rts-hosting-banner rts-hosting-banner__content dedicated__banner">
                        ...
                        <p class="slogan">Full virtualisation control on NVMe SSD storage, with a 99.99% uptime guarantee.</p>
                        <div class="hosting-action">
                            ...
                            <a href="pricing-two.php" class="btn__white">Starting @ $89.99/mo</a>
                        </div>
                    </div>
            ...
            <div class="row gy-30">
                <div class="col-lg-4 col-md-6 col-sm-6">
                    <div class="dedicated-feature">
                        ...
                        <h4 class="title">Built for Heavy Workloads</h4>
                        <p class="description">
                            High-performance processors and dedicated
                            resources handle demanding tasks with ease.
                        </p>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6 col-sm-6">
                    <div class="dedicated-feature">
                        ...
                        <h4 class="title">Blazing-Fast NVMe SSD Storage</h4>
                        <p class="description">
                            Up to 6x faster read/write speeds than
                            standard SSDs, for lower load times.
                        </p>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6 col-sm-6">
                    <div class="dedicated-feature">
                        ...
                        <h4 class="title">Full Root Access</h4>
                        <p class="description">
                            Complete OS-level control with KVM-based
                            virtualisation — configure it your way.
                        </p>
                    </div>
                </div>
            </div>
            ...
            <div class="row gy-30 justify-content-center">
                <div class="col-lg-6 col-xl-4 col-md-12">
                    <div class="dedicated-feature-section">
                        ...
                        <p>Dedicated servers from Cleva use the best hardware and software available to ensure and always fast.</p>
                ...
                <div class="col-lg-3 col-md-4 col-sm-6">
                    <div class="card-feature">
                        <div class="card-feature__single">
                            ...
                            <p class="card-feature__single--description">
                                Every plan is sized with dedicated
                                RAM and NVMe storage, never shared.
                            </p>
                        </div>
                    </div>
                </div>
                <div class="col-lg-3 col-md-4 col-sm-6">
                    <div class="card-feature">
                        <div class="card-feature__single">
                            ...
                            <p class="card-feature__single--description">
                                Your server is provisioned and
                                ready within hours, not days.
                            </p>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="swiper-slide">
                            <div class="feedback-card">
                                ...
                                <div class="feedback-card__single">
                                    ...
                                    <p class="feedback-card__single--text">Having a dedicated server without managing the hardware ourselves has been a huge relief for our small team.</p>
                        ...
                        <div class="swiper-slide">
                            <div class="feedback-card">
                                ...
                                <div class="feedback-card__single">
                                    ...
                                    <p class="feedback-card__single--text">Root access with real support on standby means we get the control we need without the risk.</p>
                                    <div class="feedback-card__single--author">
                                        <div class="author">
                        ...
                        <div class="swiper-slide">
                            <div class="feedback-card">
                                ...
                                <div class="feedback-card__single">
                                    ...
                                    <p class="feedback-card__single--text">Performance on our dedicated box has been consistent even under heavy database load.</p>
                                    <div class="feedback-card__single--author">
                                        <div class="author">
                        ...
                        <div class="swiper-slide">
                            <div class="feedback-card">
                                ...
                                <div class="feedback-card__single">
                                    ...
                                    <p class="feedback-card__single--text">We host every client project on one dedicated server now, and resource isolation has never been an issue.</p>
                                    <div class="feedback-card__single--author">
                                        <div class="author">
                        ...
                        <div class="accordion accordion-flush" id="rts-accordion">
                            <div class="accordion-item active">
                                ...
                                <div id="item__one" class="accordion-collapse collapse collapse show" aria-labelledby="first" data-bs-parent="#rts-accordion">
                                    <div class="accordion-body">
                                        A dedicated server gives you an entire physical machine — every CPU core, all RAM and storage — with nothing shared. A VPS partitions one physical server into multiple virtual servers.
                                    </div>
                                </div>
                            </div>
                            <div class="accordion-item">
                                ...
                                <div id="item__two" class="accordion-collapse collapse" aria-labelledby="two" data-bs-parent="#rts-accordion">
                                    <div class="accordion-body">
                                        You can choose from all major Linux distributions, with full root access to configure the server exactly as your application requires.
                                    </div>
                                </div>
                            </div>
                            <div class="accordion-item">
                                ...
                                <div id="item__three" class="accordion-collapse collapse" aria-labelledby="three" data-bs-parent="#rts-accordion">
                                    <div class="accordion-body">
                                        Yes, redundant storage and optional automated backups protect your data, and each server is isolated on its own hardware for maximum security.
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="accordion-item">
                                <div class="accordion-header" id="four">
                                    <h4 class="accordion-button collapsed" data-bs-toggle="collapse" data-bs-target="#item__four" aria-expanded="false" aria-controls="item__four">
                                        Can I get help setting up and managing my server?
                                    </h4>
                                </div>
                                <div id="item__four" class="accordion-collapse collapse" aria-labelledby="four" data-bs-parent="#rts-accordion">
                                    <div class="accordion-body">
                                        Our support team is available 24/7 for server-level assistance, and fully-managed setup is available if you'd rather we handle the configuration.
                                    </div>
                                </div>
                            </div>
                            <div class="accordion-item">
                                <div class="accordion-header" id="five">
                                    <h4 class="accordion-button collapsed" data-bs-toggle="collapse" data-bs-target="#item__five" aria-expanded="false" aria-controls="item__four">
                                        What kind of workloads suit dedicated hosting?
                                    </h4>
                                </div>
                                <div id="item__five" class="accordion-collapse collapse" aria-labelledby="five" data-bs-parent="#rts-accordion">
                                    <div class="accordion-body">
                                        Dedicated servers are ideal for high-traffic sites, large databases, game servers, and any workload that needs guaranteed, uncontended resources.
                                    </div>
                                </div>
                            </div>
