...
$canonical = 'blog-grid-2.php';
$ogTitle = 'Blog - Cleva';
$ogDescription = 'Your Ultimate Solution for Web Hosting, Domains, and Reseller Services';
$ogUrl = 'https://clevahost.com/blog-grid-2.php';
$twitterTitle = 'Blog - Cleva';
                    ...
                    <div class="col-lg-6">
                        <div class="blog-wrapper">
                            ...
                            <div class="content">
                                ...
                                <a href="#" class="read-more-btn">Read More <i class="fa-light fa-angle-right"></i></a>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-6">
