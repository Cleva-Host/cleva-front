...
$canonical = 'about.php';
$ogTitle = 'About Us - Cleva';
$ogDescription = 'Your Ultimate Solution for Web Hosting, Domains, and Reseller Services';
$ogUrl = 'https://clevahost.com/about.php';
$twitterTitle = 'About Us - Cleva';
            ...
            <div class="row">
                <div class="banner-area">
                    <div class="rts-hosting-banner rts-hosting-banner__content about__banner">
                        <span class="starting__price" data-sal="slide-down" data-sal-delay="100" data-sal-duration="800">About Cleva</span>
                        ...
                        <p class="slogan" data-sal="slide-down" data-sal-delay="300" data-sal-duration="800">What makes Cleva unique is our extraordinary
                            team of individuals who put their passion into every customer's success.</p>
                ...
                <div class="col-12">
                    <div class="rts-data-center__location">
                        ...
                        <ul class="round-shape">
                            <li class="one">
                                <span class="tolltip1" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-custom-class="color-cleva" title="Canada"></span>
                                <img src="assets/images/flag-01.svg" alt="">
                            </li>
                            <li class="two">
                                <span class="tolltip1" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-custom-class="color-cleva" title="Germany"></span>
                                <img src="assets/images/flag-02.svg" alt="">
                            </li>
                            <li class="three">
                                <span class="tolltip1" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-custom-class="color-cleva" title="Russia"></span>
                                <img src="assets/images/flag-03.svg" alt="">
                            </li>
                            <li class="four">
                                <span class="tolltip1" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-custom-class="color-cleva"  title="USA"></span>
                                <img src="assets/images/flag-04.svg" alt="">
                            </li>
                            <li class="five">
                                <span class="tolltip1" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-custom-class="color-cleva" title="Egypt"></span>
                                <img src="assets/images/flag-05.svg" alt="">
                            </li>
                            <li class="six">
                                <span class="tolltip1" data-bs-toggle="tooltip" data-bs-placement="top"  data-bs-custom-class="color-cleva" title="India"></span>
                                <img src="assets/images/flag-06.svg" alt="">
                            </li>
                            <li class="seven">
                                <span class="tolltip1" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-custom-class="color-cleva" title="China"></span>
                                <img src="assets/images/flag-07.svg" alt="">
                            </li>
                            <li class="eight">
                                <span class="tolltip1" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-custom-class="color-cleva" title="Brazil"></span>
                                <img src="assets/images/flag-08.svg" alt="">
                            </li>
                            <li class="nine">
                                <span class="tolltip1" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-custom-class="color-cleva"  title="South Africa"></span>
                                <img src="assets/images/flag-09.svg" alt="">
                            </li>
                            <li class="ten">
                                <span class="tolltip1" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-custom-class="color-cleva" title="Australia"></span>
    ...
    <section class="rts-team-area pt--120 pb--120">
        <div class="container">
            <div class="rts-section-title-area">
                ...
                <p class="desc w-450" data-sal="slide-down" data-sal-delay="300" data-sal-duration="800">From a small hosting reseller to a team supporting tens of thousands of
                    websites, the people behind Cleva are the reason our customers stay.</p>
            </div>
                        ...
                        <div class="swiper-slide">
                            <div class="feedback-card">
                                ...
                                <div class="feedback-card__single">
                                    ...
                                    <p class="feedback-card__single--text">Cleva's uptime has been rock solid since we moved three of our client sites over. Support responds in minutes, not days.</p>
                        ...
                        <div class="swiper-slide">
                            <div class="feedback-card">
                                ...
                                <div class="feedback-card__single">
                                    ...
                                    <p class="feedback-card__single--text">Migrating our agency's hosting to Cleva took less than an hour, and every site loaded faster the moment we switched.</p>
                                    <div class="feedback-card__single--author">
                                        <div class="author">
                                        ...
                                        <div class="author__meta">
                                            <h6>Amara Chukwu</h6>
                                            <span>Founder, Amara Designs</span>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="swiper-slide">
                            <div class="feedback-card">
                                ...
                                <div class="feedback-card__single">
                                    ...
                                    <p class="feedback-card__single--text">We manage over 40 domains for clients, and Cleva's renewal reminders alone have saved us from three expired-domain disasters this year.</p>
                                    <div class="feedback-card__single--author">
                                        <div class="author">
                        ...
                        <div class="swiper-slide">
                            <div class="feedback-card">
                                ...
                                <div class="feedback-card__single">
                                    ...
                                    <p class="feedback-card__single--text">Checkout speeds improved noticeably after we switched our store's hosting to Cleva. Our conversion rate went up within the first month.</p>
                                    <div class="feedback-card__single--author">
                                        <div class="author">
