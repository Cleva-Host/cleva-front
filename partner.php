...
$canonical = 'partner.php';
$ogTitle = 'Our Partners - Cleva';
$ogDescription = 'Your Ultimate Solution for Web Hosting, Domains, and Reseller Services';
$ogUrl = 'https://clevahost.com/partner.php';
$twitterTitle = 'Our Partners - Cleva';
                        ...
                        <div class="swiper-slide">
                            <div class="feedback-card">
                                ...
                                <div class="feedback-card__single">
                                    ...
                                    <p class="feedback-card__single--text">Partnering with Cleva gave our agency a hosting arm without the overhead of running our own servers.</p>
                        ...
                        <div class="swiper-slide">
                            <div class="feedback-card">
                                ...
                                <div class="feedback-card__single">
                                    ...
                                    <p class="feedback-card__single--text">Every partner ticket I've raised gets a real engineer on it within the hour, not a canned response.</p>
                                    <div class="feedback-card__single--author">
                                        <div class="author">
                        ...
                        <div class="swiper-slide">
                            <div class="feedback-card">
                                ...
                                <div class="feedback-card__single">
                                    ...
                                    <p class="feedback-card__single--text">White-labeling Cleva's infrastructure let us launch a branded hosting product in weeks instead of months.</p>
                                    <div class="feedback-card__single--author">
                                        <div class="author">
                        ...
                        <div class="swiper-slide">
                            <div class="feedback-card">
                                ...
                                <div class="feedback-card__single">
                                    ...
                                    <p class="feedback-card__single--text">The partner portal makes it easy to see commissions and client usage in one place.</p>
                                    <div class="feedback-card__single--author">
                                        <div class="author">
