<?php
$pageTitle = 'Shared Hosting - Cleva';
...
$canonical = 'shared-hosting.php';
$ogTitle = 'Shared Hosting - Cleva';
$ogDescription = 'Your Ultimate Solution for Web Hosting, Domains, and Reseller Services';
$ogUrl = 'https://clevahost.com/shared-hosting.php';
$twitterTitle = 'Shared Hosting - Cleva';
                ...
                <div class="col-lg-12">
                    <div class="banner-area">
                        <div class="rts-hosting-banner rts-hosting-banner__content">
                            <span class="starting__price" data-sal="slide-down" data-sal-delay="100" data-sal-duration="800">Save up to 65% &middot; Starting at $2.99/mo</span>
                            <h1 class="banner-title" data-sal="slide-down" data-sal-delay="300" data-sal-duration="800">
                                Reliable, Fast & Secure
                                Web Hosting
                            </h1>
                            <p class="slogan" data-sal="slide-down" data-sal-delay="400" data-sal-duration="800">Dream big, build bigger — hosting that won't let you down.</p>
        ...
        <div class="container">
            <div class="row justify-content-center">
                <div class="rts-section w-490 text-center">
                    <h2 class="rts-section__title" data-sal="slide-down" data-sal-delay="100" data-sal-duration="800">Choose Your Hosting Plan</h2>
                    <p class="rts-section__description" data-sal="slide-down" data-sal-delay="300" data-sal-duration="800">Every plan includes free SSL, a free domain for the first year, and unlimited <br> email accounts and databases.
                    </p>
                </div>
            </div>
            <div class="row">
                    ...
                    <div class="row g-30 monthly">
                        ...
                        <div class="col-lg-3 col-md-6 col-sm-6">
                            <div class="card-plan">
                                ...
                                <p class="card-plan__desc">8GB webspace & 2 free addon domains</p>
                                <div class="card-plan__offer">
                                    <span class="past-price"><span rt-currency-symbol>$</span><span rt-price>8.99</span></span></span>
                                    <span class="offer-given">Save 65%</span>
                                </div>
                                <h5 class="card-plan__price">
                                    <sup rt-currency-symbol>$</sup> <span rt-price>2.99</span></span><sub>/ month</sub>
                                </h5>
                                <div class="card-plan__cartbtn">
                                    <a href="#">add to cart</a>
                                </div>
                                <p class="card-plan__renew-price">
                                    <span rt-currency-symbol>$</span> <span rt-price>2.99</span> /mo when you renew
                                </p>
                        ...
                        <div class="col-lg-3 col-md-6 col-sm-6">
                            <div class="card-plan">
                                ...
                                <p class="card-plan__desc">15GB webspace & 3 free addon domains</p>
                                <div class="card-plan__offer">
                                    <span class="past-price"><span rt-currency-symbol>$</span><span rt-price>12.99</span></span>
                                    <span class="offer-given">Save 65%</span>
                                </div>
                                <h5 class="card-plan__price">
                                    <sup rt-currency-symbol>$</sup> <span rt-price>4.49</span></span> <sub>/ month</sub>
                                </h5>
                                <div class="card-plan__cartbtn">
                                    <a href="#">add to cart</a>
                                </div>
                                <p class="card-plan__renew-price">
                                    <span rt-currency-symbol>$</span> <span rt-price>4.49</span> /mo when you renew
                                </p>
                                <div class="card-plan__feature">
                                    <ul class="card-plan__feature--list">
                                        <li class="card-plan__feature--list-item">
                        ...
                        <div class="col-lg-3 col-md-6 col-sm-6">
                            <div class="card-plan active">
                                ...
                                <div class="card-plan__package">
                                    ...
                                    <h4 class="package__name">Deluxe</h4>
                                </div>
                                <p class="card-plan__desc">30GB webspace & 5 free addon domains</p>
                                <div class="card-plan__offer">
                                    <span class="past-price"><span rt-currency-symbol>$</span><span rt-price>17.99</span></span>
                                    <span class="offer-given">Save 65%</span>
                                </div>
                                <h5 class="card-plan__price">
                                    <sup rt-currency-symbol>$</sup> <span rt-price>6.49</span></span> <sub>/ month</sub>
                                </h5>
                                <div class="card-plan__cartbtn">
                                    <a href="#">add to cart</a>
                                </div>
                                <p class="card-plan__renew-price">
                                    <span rt-currency-symbol>$</span> <span rt-price>6.49</span> /mo when you renew
                                </p>
                                <div class="card-plan__feature">
                                    <ul class="card-plan__feature--list">
                                        <li class="card-plan__feature--list-item">
                        ...
                        <div class="col-lg-3 col-md-6 col-sm-6">
                            <div class="card-plan ">
                                ...
                                <div class="card-plan__package">
                                    ...
                                    <h4 class="package__name">Supreme</h4>
                                </div>
                                <p class="card-plan__desc">120GB webspace & 10 free addon domains</p>
                                <div class="card-plan__offer">
                                    <span class="past-price"> <span rt-currency-symbol>$</span><span rt-price>24.99</span></span>
                                    <span class="offer-given">Save 65%</span>
                                </div>
                                <h5 class="card-plan__price">
                                    <sup rt-currency-symbol>$</sup> <span rt-price>8.99</span></span> <sub>/ month</sub>
                                </h5>
                                <div class="card-plan__cartbtn">
                                    <a href="#">add to cart</a>
                                </div>
                                <p class="card-plan__renew-price">
                                    <span rt-currency-symbol>$</span> <span rt-price>8.99</span> /mo when you renew
                                </p>
                                <div class="card-plan__feature">
                                    <ul class="card-plan__feature--list">
                                        <li class="card-plan__feature--list-item">
                    ...
                    <div class="row g-30 yearly">
                        ...
                        <div class="col-lg-3 col-md-6 col-sm-6">
                            <div class="card-plan">
                                ...
                                <p class="card-plan__renew-price">
                                    <span rt-currency-symbol>$</span> <span rt-price>79.99</span> /mo when you renew
                                </p>
                                <div class="card-plan__feature">
                                    <ul class="card-plan__feature--list">
                                        <li class="card-plan__feature--list-item">
                        ...
                        <div class="col-lg-3 col-md-6 col-sm-6">
                            <div class="card-plan">
                                ...
                                <p class="card-plan__renew-price">
                                    <span rt-currency-symbol>$</span> <span rt-price>151.99</span> /mo when you renew
                                </p>
                                <div class="card-plan__feature">
                                    <ul class="card-plan__feature--list">
                                        <li class="card-plan__feature--list-item">
                        ...
                        <div class="col-lg-3 col-md-6 col-sm-6">
                            <div class="card-plan ">
                                ...
                                <h5 class="card-plan__price">
                                    <sup rt-currency-symbol>$</sup> <span rt-price>169.63</span> <sub>/ month</sub>
                                </h5>
                                <div class="card-plan__cartbtn">
                                    <a href="#">add to cart</a>
                                </div>
                ...
                <div class="col-lg-3 col-sm-6" data-sal="slide-down" data-sal-delay="400" data-sal-duration="800">
                    <div class="card-feature">
                        <div class="card-feature__single">
                            ...
                            <p class="card-feature__single--description">
                                SSD storage and a global network
                                keep your site loading in an instant.
                            </p>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-3 col-sm-6" data-sal="slide-down" data-sal-delay="500" data-sal-duration="800">
                    <div class="card-feature">
                        <div class="card-feature__single">
                            ...
                            <p class="card-feature__single--description">
                                One-click installs and an intuitive
                                dashboard, even for first-timers.
                            </p>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-3 col-sm-6" data-sal="slide-down" data-sal-delay="600" data-sal-duration="800">
                    <div class="card-feature">
                        <div class="card-feature__single">
                            ...
                            <p class="card-feature__single--description">
                                Real people, reachable by chat or
                                email, any time you need help.
                            </p>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="hosting-feature">
                        ...
                        <div class="feature">
                            <ul class="feature__list" data-sal="slide-down" data-sal-delay="400" data-sal-duration="800">
                                ...
                                <li class="feature__item">Cleva Control Panel</li>
                        ...
                        <div class="swiper-slide">
                            <div class="feedback-card">
                                ...
                                <div class="feedback-card__single">
                                    ...
                                    <p class="feedback-card__single--text">For a first website, Cleva's shared hosting had everything we needed without a steep learning curve.</p>
                        ...
                        <div class="swiper-slide">
                            <div class="feedback-card">
                                ...
                                <div class="feedback-card__single">
                                    ...
                                    <p class="feedback-card__single--text">The one-click WordPress install on shared hosting saved me from an afternoon of manual setup.</p>
                                    <div class="feedback-card__single--author">
                                        <div class="author">
                        ...
                        <div class="swiper-slide">
                            <div class="feedback-card">
                                ...
                                <div class="feedback-card__single">
                                    ...
                                    <p class="feedback-card__single--text">Even on the entry-level shared plan, our staging site never felt sluggish.</p>
                                    <div class="feedback-card__single--author">
                                        <div class="author">
                        ...
                        <div class="swiper-slide">
                            <div class="feedback-card">
                                ...
                                <div class="feedback-card__single">
                                    ...
                                    <p class="feedback-card__single--text">I started my blog on Cleva's cheapest shared plan and never had a single downtime alert in a year.</p>
                                    <div class="feedback-card__single--author">
                                        <div class="author">
                    ...
                    <div class="accordion accordion-flush" id="rts-accordion">
                        <div class="accordion-item active">
                            <div class="accordion-header" id="first">
                                <h4 class="accordion-button collapse show" data-bs-toggle="collapse" data-bs-target="#item__one" aria-expanded="false" aria-controls="item__one">
                                    Which hosting plan is right for a small business?
                                </h4>
                            </div>
                            <div id="item__one" class="accordion-collapse collapse collapse show" aria-labelledby="first" data-bs-parent="#rts-accordion">
                                <div class="accordion-body">
                                    Premium or Pro cover most small business sites comfortably. If you're running an online store or expect steady traffic growth, Deluxe or Supreme give you more storage, bandwidth and addon domains to grow into.
                                </div>
                            </div>
                        </div>
                        <div class="accordion-item">
                            ...
                            <div id="item__two" class="accordion-collapse collapse" aria-labelledby="two" data-bs-parent="#rts-accordion">
                                <div class="accordion-body">
                                    Yes. Every shared hosting plan includes a free domain for the first year, plus 2 to 10 addon domains depending on your tier, so you can host multiple sites from one account.
                                </div>
                            </div>
                        </div>
                        <div class="accordion-item">
                            <div class="accordion-header" id="three">
                                <h4 class="accordion-button collapsed" data-bs-toggle="collapse" data-bs-target="#item__three" aria-expanded="false" aria-controls="item__three">
                                    Is SSL included, or do I need to buy it separately?
                                </h4>
                            </div>
                            <div id="item__three" class="accordion-collapse collapse" aria-labelledby="three" data-bs-parent="#rts-accordion">
                                <div class="accordion-body">
                                    SSL is included free on every plan and renews automatically for as long as you host with us, so your site shows the padlock from day one at no extra cost.
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="accordion-item">
                            <div class="accordion-header" id="four">
                                <h4 class="accordion-button collapsed" data-bs-toggle="collapse" data-bs-target="#item__four" aria-expanded="false" aria-controls="item__four">
                                    Can I upgrade my plan later as my site grows?
                                </h4>
                            </div>
                            <div id="item__four" class="accordion-collapse collapse" aria-labelledby="four" data-bs-parent="#rts-accordion">
                                <div class="accordion-body">
                                    Absolutely. You can move up to a higher tier at any time from your account panel — your site, email and files carry over with no downtime.
                                </div>
                            </div>
                        </div>
                        <div class="accordion-item">
                            <div class="accordion-header" id="five">
                                <h4 class="accordion-button collapsed" data-bs-toggle="collapse" data-bs-target="#item__five" aria-expanded="false" aria-controls="item__four">
                                    Do you offer free website migration from another host?
                                </h4>
                            </div>
                            <div id="item__five" class="accordion-collapse collapse" aria-labelledby="five" data-bs-parent="#rts-accordion">
                                <div class="accordion-body">
                                    Yes, our team will migrate your existing website, emails and databases to Cleva at no charge, with minimal downtime for your visitors.
                                </div>
                            </div>
                        </div>
