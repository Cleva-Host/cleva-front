<?php
$pageTitle = 'Game Server Hosting - Cleva';
...
$canonical = 'game-details.php';
$ogTitle = 'Game Server Hosting - Cleva';
$ogDescription = 'Your Ultimate Solution for Web Hosting, Domains, and Reseller Services';
$ogUrl = 'https://clevahost.com/game-details.php';
$twitterTitle = 'Game Server Hosting - Cleva';
$twitterDescription = 'Your Ultimate Solution for Web Hosting, Domains, and Reseller Services';
$bodyClass = 'template-game template-game-details';
?>
