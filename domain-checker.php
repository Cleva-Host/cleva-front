<?php
$pageTitle = 'Domain Checker - Cleva';
...
$canonical = 'domain-checker.php';
$ogTitle = 'Domain Checker - Cleva';
$ogDescription = 'Your Ultimate Solution for Web Hosting, Domains, and Reseller Services';
$ogUrl = 'https://clevahost.com/domain-checker.php';
$twitterTitle = 'Domain Checker - Cleva';
...
<?php include 'components/header.php'; ?>
            ...
            <div class="row align-items-center">
                <div class="col-lg-12">
                    <div class="rts-hero__content domain">
                        <h1 data-sal="slide-down" data-sal-delay="100" data-sal-duration="800">Find Your Perfect
                            Domain Name
                        </h1>
                        <p class="description" data-sal="slide-down" data-sal-delay="200" data-sal-duration="800">Search hundreds of extensions and secure your brand online in seconds.</p>
        ...
        <div class="container">
            ...
            <div class="row justify-content-center">
                <div class="section-title-area w-570">
                    <h2 class="section-title" data-sal="slide-down" data-sal-delay="100" data-sal-duration="800">Cleva
                        Straightforward Domain Pricing</h2>
                    <p class="desc" data-sal="slide-down" data-sal-delay="200" data-sal-duration="800">No hidden fees, no surprise renewals — just clear pricing on every extension.</p>
                </div>
            </div>
                ...
                <div class="row g-5">
                    <div class="col-lg-4 col-xl-3 col-md-4 col-sm-6" data-sal="slide-down" data-sal-delay="200" data-sal-duration="800">
                        <div class="pricing-wrapper">
                            ...
                            <div class="content">
                                <p class="desc"><strong>.com</strong> domains — register or transfer in minutes</p>
                                <div class="price-area">
                                    <span class="pre"><span rt-currency-symbol>$</span><span rt-price>12.99</span></span>
                                    <span class="now"><span rt-currency-symbol>$</span><span rt-price>8.99</span></span>
                                </div>
                    ...
                    <div class="col-lg-4 col-xl-3 col-md-4 col-sm-6" data-sal="slide-down" data-sal-delay="300" data-sal-duration="800">
                        <div class="pricing-wrapper">
                            ...
                            <div class="content">
                                <p class="desc"><strong>.net</strong> domains — register or transfer in minutes</p>
                                <div class="price-area">
                                    <span class="pre"><span rt-currency-symbol>$</span><span rt-price>14.99</span></span>
                                    <span class="now"><span rt-currency-symbol>$</span><span rt-price>10.99</span></span>
                                </div>
                                <div class="button-area">
                                    <a href="#" class="pricing-btn rts-btn">Register</a>
                                    <a href="#" class="pricing-btn rts-btn border">Transfer</a>
                    ...
                    <div class="col-lg-4 col-xl-3 col-md-4 col-sm-6" data-sal="slide-down" data-sal-delay="200" data-sal-duration="800">
                        <div class="pricing-wrapper">
                            ...
                            <div class="content">
                                <p class="desc"><strong>.org</strong> domains — register or transfer in minutes</p>
                                <div class="price-area">
                                    <span class="pre"><span rt-currency-symbol>$</span><span rt-price>15.99</span></span>
                                    <span class="now"><span rt-currency-symbol>$</span><span rt-price>11.99</span></span>
                                </div>
                                <div class="button-area">
                                    <a href="#" class="pricing-btn rts-btn">Register</a>
                                    <a href="#" class="pricing-btn rts-btn border">Transfer</a>
                    ...
                    <div class="col-lg-4 col-xl-3 col-md-4 col-sm-6" data-sal="slide-down" data-sal-delay="300" data-sal-duration="800">
                        <div class="pricing-wrapper">
                            ...
                            <div class="content">
                                <p class="desc"><strong>.info</strong> domains — register or transfer in minutes</p>
                                <div class="price-area">
                                    <span class="pre"><span rt-currency-symbol>$</span><span rt-price>9.99</span></span>
                                    <span class="now"><span rt-currency-symbol>$</span><span rt-price>4.99</span></span>
                                </div>
                                <div class="button-area">
                                    <a href="#" class="pricing-btn rts-btn">Register</a>
                                    <a href="#" class="pricing-btn rts-btn border">Transfer</a>
                    ...
                    <div class="col-lg-4 col-xl-3 col-md-4 col-sm-6" data-sal="slide-down" data-sal-delay="200" data-sal-duration="800">
                        <div class="pricing-wrapper">
                            ...
                            <div class="content">
                                <p class="desc"><strong>.xyz</strong> domains — register or transfer in minutes</p>
                                <div class="price-area">
                                    <span class="pre"><span rt-currency-symbol>$</span><span rt-price>3.99</span></span>
                                    <span class="now"><span rt-currency-symbol>$</span><span rt-price>1.99</span></span>
                                </div>
                                <div class="button-area">
                                    <a href="#" class="pricing-btn rts-btn">Register</a>
                                    <a href="#" class="pricing-btn rts-btn border">Transfer</a>
                    ...
                    <div class="col-lg-4 col-xl-3 col-md-4 col-sm-6" data-sal="slide-down" data-sal-delay="300" data-sal-duration="800">
                        <div class="pricing-wrapper">
                            ...
                            <div class="content">
                                <p class="desc"><strong>.store</strong> domains — register or transfer in minutes</p>
                                <div class="price-area">
                                    <span class="pre"><span rt-currency-symbol>$</span><span rt-price>18.99</span></span>
                                    <span class="now"><span rt-currency-symbol>$</span><span rt-price>14.99</span></span>
                                </div>
                                <div class="button-area">
                                    <a href="#" class="pricing-btn rts-btn">Register</a>
                                    <a href="#" class="pricing-btn rts-btn border">Transfer</a>
                    ...
                    <div class="col-lg-4 col-xl-3 col-md-4 col-sm-6" data-sal="slide-down" data-sal-delay="200" data-sal-duration="800">
                        <div class="pricing-wrapper">
                            ...
                            <div class="content">
                                <p class="desc"><strong>.online</strong> domains — register or transfer in minutes</p>
                                <div class="price-area">
                                    <span class="pre"><span rt-currency-symbol>$</span><span rt-price>22.99</span></span>
                                    <span class="now"><span rt-currency-symbol>$</span><span rt-price>16.99</span></span>
                                </div>
                                <div class="button-area">
                                    <a href="#" class="pricing-btn rts-btn">Register</a>
                                    <a href="#" class="pricing-btn rts-btn border">Transfer</a>
                    ...
                    <div class="col-lg-4 col-xl-3 col-md-4 col-sm-6" data-sal="slide-down" data-sal-delay="300" data-sal-duration="800">
                        <div class="pricing-wrapper">
                            ...
                            <div class="content">
                                <p class="desc"><strong>.site</strong> domains — register or transfer in minutes</p>
                                <div class="price-area">
                                    <span class="pre"><span rt-currency-symbol>$</span><span rt-price>16.99</span></span>
                                    <span class="now"><span rt-currency-symbol>$</span><span rt-price>12.99</span></span>
                                </div>
                                <div class="button-area">
                                    <a href="#" class="pricing-btn rts-btn">Register</a>
                                    <a href="#" class="pricing-btn rts-btn border">Transfer</a>
                        ...
                        <table class="table table-hover table-responsive">
                            ...
                            <tbody class="table__content">
                                ...
                                <tr>
                                    ...
                                    <td class="storage"><span rt-currency-symbol>$</span><span rt-price>2.99</span></td>d>
                                </tr>
                                <tr>
                    ...
                    <div class="card-feature">
                        <div class="card-feature__single">
                            ...
                            <p class="card-feature__single--description">
                                ...
                                questions asked, on every domain.
                            </p>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-3 col-sm-6" data-sal="slide-down" data-sal-delay="400" data-sal-duration="800">
                    <div class="card-feature">
                        <div class="card-feature__single">
                            ...
                            <p class="card-feature__single--description">
                                Instant activation and reliable
                                DNS on every domain we register.
                            </p>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-3 col-sm-6" data-sal="slide-down" data-sal-delay="500" data-sal-duration="800">
                    <div class="card-feature">
                        <div class="card-feature__single">
                            ...
                            <p class="card-feature__single--description">
                                Search, register and manage
                                domains from one simple dashboard.
                            </p>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="accordion accordion-flush" id="rts-accordion">
                            <div class="accordion-item active">
                                ...
                                <div id="item__one" class="accordion-collapse collapse collapse show" aria-labelledby="first" data-bs-parent="#rts-accordion">
                                    <div class="accordion-body">
                                        A domain name is your address on the internet — it's what people type to find your site, and what your email runs on. Every website needs one to be reachable.
                            ...
                            <div class="accordion-item">
                                <div class="accordion-header" id="two">
                                    <h4 class="accordion-button collapsed" data-bs-toggle="collapse" data-bs-target="#item__two" aria-expanded="false" aria-controls="item__two">
                                        How long does it take to activate a domain after purchase?
                                    </h4>
                                </div>
                                <div id="item__two" class="accordion-collapse collapse" aria-labelledby="two" data-bs-parent="#rts-accordion">
                                    <div class="accordion-body">
                                        Most domains are active within minutes of purchase. Some extensions with manual verification steps (like certain country-code domains) can take up to 24 hours.
                            ...
                            <div class="accordion-item">
                                ...
                                <div id="item__three" class="accordion-collapse collapse" aria-labelledby="three" data-bs-parent="#rts-accordion">
                                    <div class="accordion-body">
                                        No, you can register a domain on its own and point it anywhere. Pairing it with a Cleva hosting plan just makes setup faster since DNS is configured automatically.
                            ...
                            <div class="accordion-item">
                                <div class="accordion-header" id="four">
                                    <h4 class="accordion-button collapsed" data-bs-toggle="collapse" data-bs-target="#item__four" aria-expanded="false" aria-controls="item__four">
                                        Will I get reminders before my domain expires?
                                    </h4>
                                </div>
                                <div id="item__four" class="accordion-collapse collapse" aria-labelledby="four" data-bs-parent="#rts-accordion">
                                    <div class="accordion-body">
                                        Yes, we email renewal reminders well ahead of your expiry date, and you can enable auto-renew so your domain never lapses unexpectedly.
                            ...
                            <div class="accordion-item">
                                <div class="accordion-header" id="five">
                                    <h4 class="accordion-button collapsed" data-bs-toggle="collapse" data-bs-target="#item__five" aria-expanded="false" aria-controls="item__four">
                                        Can I transfer a domain I already own to Cleva?
                                    </h4>
                                </div>
                                <div id="item__five" class="accordion-collapse collapse" aria-labelledby="five" data-bs-parent="#rts-accordion">
                                    <div class="accordion-body">
                                        Yes, as long as it's unlocked and past its 60-day transfer lock, you can transfer it to Cleva and we'll walk you through getting your auth code.
                                    </div>
                                </div>
                            </div>
    ...
    <script defer src="assets/js/domain-checker.js?v=<?php echo filemtime(__DIR__ . '/assets/js/domain-checker.js'); ?>"></script>
