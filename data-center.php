...
$canonical = 'data-center.php';
$ogTitle = 'Data Centers - Cleva';
$ogDescription = 'Your Ultimate Solution for Web Hosting, Domains, and Reseller Services';
$ogUrl = 'https://clevahost.com/data-center.php';
$twitterTitle = 'Data Centers - Cleva';
        ...
        <div class="container">
            <div class="row">
                <div class="rts-section text-center">
                    <h2 class="rts-section__title" data-sal="slide-down" data-sal-delay="100" data-sal-duration="800">Cleva Email Key Features</h2>
                ...
                <div class="col-xl-6 col-lg-6">
                    <div class="cdn-description">
                        ...
                        <p class="description mb-4">
                            Cleva customers enjoy a free in-house built CDN service that significantly
