...
$ogTitle = 'Contact Us - Cleva';
$ogDescription = 'Your Ultimate Solution for Web Hosting, Domains, and Reseller Services';
$ogUrl = 'https://clevahost.com/contact.php';
$twitterTitle = 'Contact Us - Cleva';
...
<?php include 'components/header.php'; ?>
            ...
            <div class="row">
                <div class="banner-area">
                    <div class="rts-hosting-banner rts-hosting-banner__content w-530 contact__banner">
                        <span class="starting__price">We're Here to Help</span>
                        <h1 class="banner-title">
                            Contact Us
                        </h1>
                        <p class="slogan">Reach our team by live chat, email, or the help center — real people, real answers, day or night.</p>
                        <div class="hosting-action">
                            <a href="knowledgebase.php" class="btn__two secondary__bg secondary__color">Visit Help Center <i class="fa-regular fa-arrow-right"></i></a>
                        </div>
                    </div>
                ...
                <div class="col-xl-3 col-lg-4 col-md-6 col-sm-10">
                    <div class="single-contact-method">
                        <div class="method">
                            ...
                            <div class="content w-220">
                                <h5 class="info mb-0">
                                    <a href="mailto:support@clevahost.com">support@clevahost.com</a> <br>
                                    <a href="mailto:support@clevahost.com">support@clevahost.com</a>
                                </h5>
                            </div>
                        </div>
                    </div>
            ...
            <div class="row gy-30 justify-content-center">
                ...
                <div class="col-xl-5 col-lg-6 offset-xl-1 col-md-10">
                    <div class="form">
                        ...
                        <form class="form__content" method="post" action="#" id="cleva-contact-form">
                        ...
                        <div id="form-messages" class="whois-lookup-message" hidden></div>
                    </div>
                </div>
            </div>
        </div>
    ...
    <!-- FOOTER AREA -->
    <!-- CONTACT FORM JS -->
    <script defer src="assets/js/contact-form.js?v=<?php echo filemtime(__DIR__ . '/assets/js/contact-form.js'); ?>"></script>
