<?php
$pageTitle = 'Reseller Hosting - Cleva';
...
$canonical = 'reseller-hosting.php';
$ogTitle = 'Reseller Hosting - Cleva';
$ogDescription = 'Your Ultimate Solution for Web Hosting, Domains, and Reseller Services';
$ogUrl = 'https://clevahost.com/reseller-hosting.php';
$twitterTitle = 'Reseller Hosting - Cleva';
            ...
            <div class="row">
                <div class="banner-area">
                    <div class="rts-hosting-banner rts-hosting-banner__content resell__banner">
                        ...
                        <p class="slogan" data-sal="slide-down" data-sal-delay="300" data-sal-duration="800">100% white-label hosting for web designers, agencies &
                            entrepreneurs.</p>
                        <div class="hosting-action" data-sal="slide-down" data-sal-delay="400" data-sal-duration="800">
                            ...
                            <a href="#" class="btn__white">Starting @ $14.99/mo</a>
                        </div>
                    </div>
        ...
        <div class="container">
            <div class="row justify-content-center">
                <div class="rts-section  text-center">
                    <h2 class="rts-section__title" data-sal="slide-down" data-sal-delay="100" data-sal-duration="800">Choose Your Reseller Plan</h2>
                    <p class="rts-section__description w-450" data-sal="slide-down" data-sal-delay="200" data-sal-duration="800">Every plan includes free domains for a year and full white-label branding.
                    </p>
                </div>
            </div>
            <div class="row">
                        ...
                        <div class="col-lg-3 col-md-6 col-sm-6">
                            <div class="card-plan">
                                <div class="card-plan__package">
                                    ...
                                    <h4 class="package__name">Bronze</h4>
                                </div>
                                <p class="card-plan__desc">50GB disk, 300GB bandwidth, 15 accounts</p>
                                <div class="card-plan__offer">
                                    <span class="past-price"><span rt-currency-symbol>$</span><span rt-price>24.99</span></span></span>
                                    <span class="offer-given">Save 60%</span>
                                </div>
                                <h5 class="card-plan__price">
                                    <sup rt-currency-symbol>$</sup> <span rt-price>14.99</span></span><sub>/ month</sub>
                                </h5>
                                <div class="card-plan__cartbtn">
                                    <a href="#">add to cart</a>
                                </div>
                                <p class="card-plan__renew-price">
                                    <span rt-currency-symbol>$</span> <span rt-price>14.99</span> /mo when you renew
                                </p>
                        ...
                        <div class="col-lg-3 col-md-6 col-sm-6">
                            <div class="card-plan">
                                <div class="card-plan__package">
                                    ...
                                    <h4 class="package__name">Silver</h4>
                                </div>
                                <p class="card-plan__desc">75GB disk, 750GB bandwidth, 25 accounts</p>
                                <div class="card-plan__offer">
                                    <span class="past-price"><span rt-currency-symbol>$</span><span rt-price>39.99</span></span>
                                    <span class="offer-given">Save 60%</span>
                                </div>
                                <h5 class="card-plan__price">
                        ...
                        <div class="col-lg-3 col-md-6 col-sm-6">
                            <div class="card-plan active">
                                ...
                                <div class="card-plan__package">
                                    ...
                                    <h4 class="package__name">Steel</h4>
                                </div>
                                <p class="card-plan__desc">100GB disk, unlimited bandwidth, 40 accounts</p>
                                <div class="card-plan__offer">
                                    <span class="past-price"><span rt-currency-symbol>$</span><span rt-price>59.99</span></span>
                                    <span class="offer-given">Save 60%</span>
                                </div>
                                <h5 class="card-plan__price">
                                    <sup rt-currency-symbol>$</sup> <span rt-price>34.99</span></span> <sub>/ month</sub>
                                </h5>
                                <div class="card-plan__cartbtn">
                                    <a href="#">add to cart</a>
                                </div>
                                <p class="card-plan__renew-price">
                                    <span rt-currency-symbol>$</span> <span rt-price>34.99</span> /mo when you renew
                                </p>
                                <div class="card-plan__feature">
                                    <ul class="card-plan__feature--list">
                                        <li class="card-plan__feature--list-item">
                        ...
                        <div class="col-lg-3 col-md-6 col-sm-6">
                            <div class="card-plan ">
                                ...
                                <div class="card-plan__package">
                                    ...
                                    <h4 class="package__name">Gold</h4>
                                </div>
                                <p class="card-plan__desc">150GB disk, unlimited bandwidth, 65 accounts</p>
                                <div class="card-plan__offer">
                                    <span class="past-price"> <span rt-currency-symbol>$</span><span rt-price>84.99</span></span>
                                    <span class="offer-given">Save 60%</span>
                                </div>
                                <h5 class="card-plan__price">
                                    <sup rt-currency-symbol>$</sup> <span rt-price>49.99</span></span> <sub>/ month</sub>
                                </h5>
                                <div class="card-plan__cartbtn">
                                    <a href="#">add to cart</a>
                                </div>
                                <p class="card-plan__renew-price">
                                    <span rt-currency-symbol>$</span> <span rt-price>49.99</span> /mo when you renew
                                </p>
                                <div class="card-plan__feature">
                                    <ul class="card-plan__feature--list">
                                        <li class="card-plan__feature--list-item">
                        ...
                        <div class="swiper-slide">
                            <div class="feedback-card">
                                ...
                                <div class="feedback-card__single">
                                    ...
                                    <p class="feedback-card__single--text">Reselling Cleva's hosting let us launch a hosting brand of our own without building any infrastructure.</p>
                        ...
                        <div class="swiper-slide">
                            <div class="feedback-card">
                                ...
                                <div class="feedback-card__single">
                                    ...
                                    <p class="feedback-card__single--text">WHM access gives me full control over each client account, and provisioning a new one takes seconds.</p>
                                    <div class="feedback-card__single--author">
                                        <div class="author">
                        ...
                        <div class="swiper-slide">
                            <div class="feedback-card">
                                ...
                                <div class="feedback-card__single">
                                    ...
                                    <p class="feedback-card__single--text">Margins on the reseller plans are generous enough that hosting is now a real revenue line for us, not just a favor for clients.</p>
                                    <div class="feedback-card__single--author">
                                        <div class="author">
                        ...
                        <div class="swiper-slide">
                            <div class="feedback-card">
                                ...
                                <div class="feedback-card__single">
                                    ...
                                    <p class="feedback-card__single--text">Our clients think we run our own servers. Cleva's white-label reseller panel makes that illusion effortless.</p>
                                    <div class="feedback-card__single--author">
                                        <div class="author">
                            ...
                            <div class="accordion-item active">
                                <div class="accordion-header" id="first">
                                    <h4 class="accordion-button collapse show" data-bs-toggle="collapse" data-bs-target="#item__one" aria-expanded="false" aria-controls="item__one">
                                        Do my clients know Cleva is behind the hosting?
                                    </h4>
                                </div>
                                <div id="item__one" class="accordion-collapse collapse collapse show" aria-labelledby="first" data-bs-parent="#rts-accordion">
                                    <div class="accordion-body">
                                        No. Reseller hosting is 100% white-label — your brand is what your clients see everywhere, from the control panel to support emails. Cleva stays invisible.
                                    </div>
                                </div>
                            </div>
                            <div class="accordion-item">
                                <div class="accordion-header" id="two">
                                    <h4 class="accordion-button collapsed" data-bs-toggle="collapse" data-bs-target="#item__two" aria-expanded="false" aria-controls="item__two">
                                        Do I need technical skills to run a reseller business?
                                    </h4>
                                </div>
                                <div id="item__two" class="accordion-collapse collapse" aria-labelledby="two" data-bs-parent="#rts-accordion">
                                    <div class="accordion-body">
                                        No deep technical background is required. Our reseller control panel makes it simple to create and manage client accounts, billing, and packages from day one.
                                    </div>
                                </div>
                            </div>
                            <div class="accordion-item">
                                <div class="accordion-header" id="three">
                                    <h4 class="accordion-button collapsed" data-bs-toggle="collapse" data-bs-target="#item__three" aria-expanded="false" aria-controls="item__three">
                                        Can I set my own prices for my clients?
                                    </h4>
                                </div>
                                <div id="item__three" class="accordion-collapse collapse" aria-labelledby="three" data-bs-parent="#rts-accordion">
                                    <div class="accordion-body">
                                        Yes, you have full control over your own packages and pricing — what you charge your clients is entirely up to you.
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="accordion-item">
                                <div class="accordion-header" id="four">
                                    <h4 class="accordion-button collapsed" data-bs-toggle="collapse" data-bs-target="#item__four" aria-expanded="false" aria-controls="item__four">
                                        Can I upgrade my reseller plan as I grow?
                                    </h4>
                                </div>
                                <div id="item__four" class="accordion-collapse collapse" aria-labelledby="four" data-bs-parent="#rts-accordion">
                                    <div class="accordion-body">
                                        Yes, you can move up to a higher tier at any time as your client base grows, with no interruption to your existing accounts.
                                    </div>
                                </div>
                            </div>
                            <div class="accordion-item">
                                <div class="accordion-header" id="five">
                                    <h4 class="accordion-button collapsed" data-bs-toggle="collapse" data-bs-target="#item__five" aria-expanded="false" aria-controls="item__four">
                                        Do reseller plans include free domains?
                                    </h4>
                                </div>
                                <div id="item__five" class="accordion-collapse collapse" aria-labelledby="five" data-bs-parent="#rts-accordion">
                                    <div class="accordion-body">
                                        Yes, every reseller plan includes free domains for the first year, which you can allocate to your own clients.
                                    </div>
                                </div>
                            </div>
